...
mem_init(void)
{
	...
	i386_detect_memory(); // just populates the 'npages' and 'npages_basemem' variables above

	//////////////////////////////////////////////////////////////////////
	// create initial page directory.
	kern_pgdir = (pde_t *) boot_alloc(PGSIZE); //kern_pgdir is just a pointer to the 4096 bytes of data for ONE page DIRECTORY 
	memset(kern_pgdir, 0, PGSIZE); //this just sets all the values in the newly-allocated page to all zeros
	...
	//I am able to use boot_alloc() here because I am not suppposed to use boot_alloc after finishing the page_init() function
	...
	//because the main Page Directory has already been allocated in kern_pgdir array
	...
	//PTSIZE because you want to allocate all of UPAGES size, but make it to the physical address of pages?
...
boot_map_region(pde_t *pgdir, uintptr_t va, size_t size, physaddr_t pa, int perm)
{
	...
	//NOTE: "size is a multiple of PGSIZE" means that size is 0, 4096, 8192, 12288, etc. It does NOT mean that 's' is '1' for 4096,
	// '2' for 8192, etc 
