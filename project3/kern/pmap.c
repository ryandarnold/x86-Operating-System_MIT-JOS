...
mem_init(void)
{
	...
	//NOTE: cannot do boot_map_region() like I originally thought because it requires page_init() first
	//NOTE: pages only has enough memory allocated for it to store the metadata of it, NOT every page possible
	// which is why we have enough space to store data in the 'envs' variable
...
user_mem_check(struct Env *env, const void *va, size_t len, int perm)
{
	...
	for (int i = 0; i < num_of_pages; i++)
	{
		 ...
		 {
			 //page table does NOT have correct permissions
			 user_mem_check_addr = (uintptr_t)current_va;
			 return -E_FAULT;
		 }
	}
	...
	//otherwise all the addresses checked out and are all valid!
	return 0;
}
