	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800208:	0f be 80 61 0e 80 00 	movsbl 0x800e61(%eax),%eax
  80020f:	50                   	push   %eax
...
0080025f <vprintfmt>:
{
  ...
  8002af:	3e ff 24 85 f0 0e 80 	notrack jmp *0x800ef0(,%eax,4)
  8002b6:	00 
  ...
  80037c:	8b 14 85 48 10 80 00 	mov    0x801048(,%eax,4),%edx
  800383:	85 d2                	test   %edx,%edx
  800385:	74 18                	je     80039f <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  800387:	52                   	push   %edx
  800388:	68 82 0e 80 00       	push   $0x800e82
  80038d:	53                   	push   %ebx
  80038e:	56                   	push   %esi
  ...
  80039f:	50                   	push   %eax
  8003a0:	68 79 0e 80 00       	push   $0x800e79
  8003a5:	53                   	push   %ebx
  8003a6:	56                   	push   %esi
  ...
  8003c7:	b8 72 0e 80 00       	mov    $0x800e72,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b51:	68 64 10 80 00       	push   $0x801064
  800b56:	6a 23                	push   $0x23
  800b58:	68 81 10 80 00       	push   $0x801081
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ba5:	56                   	push   %esi
  800ba6:	50                   	push   %eax
  800ba7:	68 90 10 80 00       	push   $0x801090
  ...
  800bb8:	e8 4a f5 ff ff       	call   800107 <vcprintf>
	cprintf("\n");
  800bbd:	c7 04 24 b3 10 80 00 	movl   $0x8010b3,(%esp)
